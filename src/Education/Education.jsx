...
const StudentInfo = ({name,grade,school}) => {
    ...
    return(
    <h4> 
        Student Name: {name} , Grade: {grade}, School:{school}</h4>
    );
};
...
const TeacherInfo = ({ teacher,subject,className}) => {
    ...
    return(
        <p>
        TeacherName: {teacher}, Subject:{subject} , ClassName:{className} </p>
    );
};
...
const CourseInfo= ({courseName, duration, instructor})=>{
    return(
        <p>
            Course:{courseName}, Duration:{duration}, Instructor:{instructor} </p>
    );
};
...
const ScientistInfo= ({scientists, invention})=>{
    return(
        <p>
            Scientists:{scientists}, Invention:{invention}</p>
    );
};
...
const LibraryInfo= ({libraryName, librarian, timing, books}) =>{
    return(
        <p>
            Library:{libraryName}, Librarian:{librarian}, Timing:{timing}, Books:{books} </p>
    );
}; 
...
const SubjectInfo=({subjectName, teacher, marks}) =>{
    return(
        <p>
            Subject:{subjectName}, Teacher:{teacher}, Marks:{marks} </p>
    );
};
